...
<form action="<?php echo JUri::getInstance(); ?>" id="adminForm" name="adminForm" method="post">
  ...
  <table class="table table-striped">
      <thead>
          <tr>
              <th><?php echo JHtmlGrid::sort('文章ID', 'id', $currentDir, $currentOrder); ?></th>
              <th><?php echo JHtmlGrid::sort('標題', 'title', $currentDir, $currentOrder); ?></th>
              <th><?php echo JHtmlGrid::sort('發布狀態', 'published', $currentDir, $currentOrder); ?></th>
              <th><?php echo JHtmlGrid::sort('簡介內容', 'introtext', $currentDir, $currentOrder); ?></th>
              <th><?php echo JHtmlGrid::sort('全文內容', 'fulltext', $currentDir, $currentOrder); ?></th>
              <th><?php echo JHtmlGrid::sort('刪除', 'delete', $currentDir, $currentOrder); ?></th>
          </tr>
      </thead>
      <tbody>
